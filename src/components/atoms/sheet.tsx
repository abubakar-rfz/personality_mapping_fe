  ...
  return (
    <SheetPortal>
      ...
      <SheetPrimitive.Content
        ...
        className={cn(
          "fixed z-[51] flex flex-col gap-0 bg-[#FCFCFC] dark:bg-[#121212] shadow-2xl transition ease-in-out data-[state=closed]:animate-out data-[state=open]:animate-in data-[state=closed]:duration-300 data-[state=open]:duration-300",
          side === "left" &&
          ...
          side === "right" &&
            "inset-y-0 right-0 h-full w-[min(100vw-2rem,32rem)] border-l border-[#E5E7EB] dark:border-zinc-800/50 data-[state=closed]:slide-out-to-right data-[state=open]:slide-in-from-right",
          side === "top" &&
            "inset-x-0 top-0 h-auto border-b border-[#E5E7EB] dark:border-zinc-800/50 data-[state=closed]:slide-out-to-top data-[state=open]:slide-in-from-top",
          side === "bottom" &&
            "inset-x-0 bottom-0 h-auto border-t border-[#E5E7EB] dark:border-zinc-800/50 data-[state=closed]:slide-out-to-bottom data-[state=open]:slide-in-from-bottom",
          className,
        )}
        {...props}
      >
