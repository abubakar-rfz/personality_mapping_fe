...
export function DualSlider({
  ...
  return (
    <div className="space-y-6 rounded-2xl border border-gray-100 dark:border-zinc-800 bg-white dark:bg-[#121212] p-6 shadow-sm">
      ...
      <div className="relative pt-2">
        <input
          ...
          className="h-2.5 w-full cursor-pointer appearance-none rounded-lg bg-gray-100 dark:bg-zinc-900 accent-[#034350] focus:outline-none"
        />
